...
class _HomeContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final extraHeight = ((scale - 1).clamp(0, 1.5) * 100).toDouble();
    return SafeArea(
      bottom: false,
...
class _TopBar extends StatelessWidget {
  const _TopBar({required this.onSearch, required this.onNotifications});
  final VoidCallback? onSearch;
  final VoidCallback? onNotifications;
...
class _ContinueCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Semantics(
    ...
    label: 'Continue ${series.title}, ${series.episodeLabel}',
    child: InkWell(
      onTap: onTap,
...
class _PosterCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Semantics(
    button: true,
    excludeSemantics: true,
    label: 'Open ${series.title}, ${series.episodeLabel}',
    child: InkWell(
      onTap: onTap,
      borderRadius: BorderRadius.circular(18),
      child: Column(
