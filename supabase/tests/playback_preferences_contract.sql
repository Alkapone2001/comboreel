...
begin
  if exists (
    ...
    where id = '71717171-7171-4717-8717-717171717171'
      and (not subtitles_enabled or playback_muted or playback_speed <> 1.00)
  ) then
...
set subtitles_enabled = false, playback_muted = true, playback_speed = 1.50
where id = '71717171-7171-4717-8717-717171717171';
...
begin
  if not exists (
    select 1 from public.profiles
    where id = '71717171-7171-4717-8717-717171717171'
      and not subtitles_enabled and playback_muted and playback_speed = 1.50
  ) then
